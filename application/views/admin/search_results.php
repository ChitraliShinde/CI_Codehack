                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="breadcome-heading">
                                    ...
                                    <?= form_error('query',"<pre class='navbar-text text-danger'>",'</pre>'); ?>
                                    <?= form_close(); ?>
                                </div>
                            </div> 
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td  style="width: 50%">
                                                <div class="row">
                                                    <div class="col-lg-2">
                                                        <?= anchor("dashboard/edit_article/{$article->id}", 'Edit', ['class'=>'btn btn-primary','data-toggle'=>'tooltip','title'=>'Edit','aria-hidden'=>'true'] ); ?>
                                                    </div>
                                                    <div class="col-lg-2">

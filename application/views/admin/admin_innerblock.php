        <div class="analytics-sparkle-area" style="margin-top: 30px;">
                ...
                <div class="row">
                    <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-sales-chart">
                            ...
                            <!-- <div id="chartContainer" style="height: 356px;"></div> -->
                        </div>
                    </div>
                        ...
                        <div class="product-sales-chart">
                            <div class="portlet-title">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <div class="caption pro-sl-hd">
                                            <span class="caption-subject"><b>Admission Statistic</b></span>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="analysis-progrebar res-mg-t-30 mg-ub-10 res-mg-b-30 table-mg-t-pro-n tb-sm-res-d-n dk-res-t-d-n">
                            <div class="analysis-progrebar-content">
                                ...
                                <div class="m-t-sm small">
                                    <p>Execution Time: <?php echo $this->benchmark->elapsed_time();?></p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="white-box">
                            ...
                            <ul class="basic-list">
                                <li>Google Chrome <span class="pull-right label-danger label-1 label">
                                    <?= $chrome; ?></span></li>
                                <li>Mozila Firefox <span class="pull-right label-purple label-2 label"><?= $mozila; ?></span></li>
                                <li>Microsoft Edge <span class="pull-right label-success label-3 label"><?= $edge; ?></span></li>
                                <li>Internet Explorer <span class="pull-right label-info label-4 label"><?= $internet_explorer; ?></span></li>
                                <li>Apple Safari <span class="pull-right label-purple label-6 label"><?= $apple_safari; ?></span></li>
                                <li>Safari <span class="pull-right label-purple label-7 label"><?= $safari; ?></span></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
